...
export default {
  ...
  methods: {
    ...
    jobSearch(job) {
      this.loading = true;
      this.sample_type_water_is = false;
      console.log('begin execute search job -> sample_type_water_is = ',this.sample_type_water_is)
      if (job.includes('HB')) {
      ...
      this.$axios
        ...
        .then(() => {
          ...
          //Add by Sam Lam 13 May 2022 - don't print prep label case of AGS_TYPE=EW
          this.job.samples.forEach((sample, skey) => {
            //console.log('sample.TYPE=', sample.TYPE)
            if(sample.TYPE=='WATER') {
                //this.setPrepPrint(false);
                this.setPrepPrint(true);
                this.sample_type_water_is = true;
              } else {
                  this.setPrepPrint(true);
                  this.sample_type_water_is = false;
            } 
          ...
          console.log('after execute serach job -> sample_type_water_is = ',this.sample_type_water_is)
          //<END> Add by Sam Lam 13 May 2022 - don't print prep label case of AGS_TYPE=EW
    ...
    setPrepPrint(value) {
      ...
      this.job.samples.forEach((sample, sampIndex) => {
        sample.prep_labels.forEach((prepLabel, prepIndex) => {
          ...
          console.log('sample_type_water_is = ',this.sample_type_water_is)
          ...
          this.$set(
            ...
            'print',
             (this.job.samples[sampIndex].TYPE == 'WATER' && this.job.samples[sampIndex].prep_labels[prepIndex].subcon == false ) ? false : true
          );
        });
      });
    },
