  ...
  <v-row>
    <v-col>
      <v-card outlined :loading="loading">
        <v-card-title>
          <v-btn exact to="/technical/approvals" icon>
          ...
          <v-row dense v-if="!loading">
            <v-col>
              <v-tabs centered>
                ...
                <v-tab>Pre-bounced Job Exceptions</v-tab>
                              ...
                              <v-list dense>
                                ...
                                >
                                  <v-list-item
                                    ...
                                    "
                                    v-for="exception in sample.exceptions"
                                  ...
                                  >
                                    <v-list-item-content>
                                      <v-list-item-title>
                                        {{
                                          exception.exception_details.section
                                        }}
                                        -                                       
                                        {{
                                          exception.exception_details.dets
                                        }}
                                        -                                       
                                        {{
                                     ...
                                     <v-list-item-subtitle >
                                        Rule: {{ exception.RULE }}  (R{{ exception.RULESID }})
                                        , Exception TS: {{ exception.CREATED}} {{ exception.CREATED_AT}}
                                      </v-list-item-subtitle>
                                ...
                                >
                                  ...
                                  >
                                    <v-list-item-content>
                                     ...
                                     <v-list-item-subtitle >
                                        Rule: {{ exception.RULE }} (R{{ exception.RULESID }})
                                        , Result Last Update TS: {{ exception.RESULTTS }} 
                                        , Exception TS: {{ exception.CREATEDDT}}
                                      </v-list-item-subtitle>

                                      <v-list-item-subtitle
                                        v-if="exception.checked_by"
                                      >
                                        Lab approved by {{ exception.checked_by.USER_NAME }}
                                         at {{ exception.CHECKED }} {{ exception.CHECKED_AT }} 
                                      </v-list-item-subtitle>
  ...
  methods: {
    ...
    filterSamples() {
      ...
      this.jobData.samples.forEach((sample) => {
        if (this.allSamples == false && sample.exceptions.length == 0) {
          return;
        }
        this.selectedSamples.push(sample);
        sample.exceptions.forEach((exception) => {
    ...
    submit() {
      ...
      this.$axios
        .patch('/approvals/update-exception', {
